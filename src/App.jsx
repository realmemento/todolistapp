...
const inputRef = useRef(null);
    ...
    const deleteTask = (index) => {
        ...
        window.alert('Press OK if you want to delete this task');
    ...
    return (
        <div className="to-do-list font-mono text-neutral-200">
            ...
            <div className="justify-between items-center flex mt-4 mb-6">
                ...
                <button title='Add task' className="addbtn  mt-2 ml-2 rounded-lg font-xs text-xs py-1 px-6 " onClick={addTask}>Add Task</button>
            </div>
